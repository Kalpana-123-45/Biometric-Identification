...
<head>
<title>An Efficient and Privacy-Preserving Biometric Identification</title>
...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h2><a href="index.html">An Efficient and Privacy-Preserving Biometric Identification <small>Scheme in Cloud Computing</small></a></h2>
      </div>
      <div class="menu">
        <ul>
    ...
    <div class="headert_text_resize"> <img src="images/cloud.jpg" alt="" width="395" height="295" style="margin-top: 40px;"/>
      <div class="textarea">
        <h2>Cloud Login</h2>
        <br></br>
